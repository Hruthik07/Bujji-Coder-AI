...
class FileOperations:
    ...
    def list_directory(
        self, directory_path: str = ".", ignore_globs: Optional[List[str]] = None
    ) -> dict:
        """
        ...
        try:
            ...
            for item in full_path.iterdir():
                ...
                if ignore_globs:
                    ...
                    if any(
                        fnmatch.fnmatch(item.name, pattern) for pattern in ignore_globs
                    ):
                        continue
            ...
            return {"items": [], "path": None, "error": str(e)}
