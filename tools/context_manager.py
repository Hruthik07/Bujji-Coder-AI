...
class ContextManager:
    ...
    def assemble_context(
        ...
        max_tokens = (
            self.max_context_tokens_claude
        ...
        history_messages = self._process_conversation_history(
            conversation_history, model, threshold, session_id
        )
    ...
    def _process_conversation_history(
        ...
        # Need summarization
        print(
            f"[INFO] Context size ({history_tokens} tokens) exceeds threshold ({threshold}). Summarizing..."
        )
