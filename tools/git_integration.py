...
class GitService:
    ...
    def get_branches(self) -> Dict[str, Any]:
        ...
        """
        if not self.is_repo or not self.repo:
            return {"branches": [], "current": None, "remotes": []}
        ...
        try:
            ...
            return {"branches": [], "current": None, "remotes": [], "error": str(e)}
        ...
        try:
            if file_path:
                ...
                for diff_item in diff_index:
                    ...
                    file_path = (
                        diff_item.a_path
                        if hasattr(diff_item, "a_path")
                        else diff_item.b_path
                    )
                    all_diffs.append({"file": file_path, "diff": diff_text})
