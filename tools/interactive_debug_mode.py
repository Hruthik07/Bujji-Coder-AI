...
class InteractiveDebugMode:
    ...
    def __init__(
        self, workspace_path: str = ".", rag_system: Optional[RAGSystem] = None
    ):
    ...
    def complete_debug_session(
        self, file_path: str, fix_applied: bool = True
    ) -> Dict[str, Any]:
        """
    ...
    def _build_instrumentation_config(self, hypothesis: Hypothesis) -> Dict[str, Any]:
        ...
        if (
            "variable" in desc_lower
            or "variable" in inst_lower
            or "value" in inst_lower
        ):
