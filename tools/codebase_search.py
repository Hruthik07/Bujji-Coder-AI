...
class CodebaseSearch:
    ...
    def grep(
        ...
        try:
            ...
            if output_mode == "files_with_matches":
                ...
                return {"results": results, "total_matches": match_count}

        except Exception as e:
            return {"error": str(e), "results": []}

    def semantic_search(
        self, query: str, target_directories: Optional[List[str]] = None
    ) -> dict:
        """
        ...
        return {"query": query, "results": results[: Config.MAX_SEARCH_RESULTS]}
    ...
    def find_functions(
        self, name_pattern: str, file_path: Optional[str] = None
    ) -> dict:
    ...
    def find_classes(self, name_pattern: str, file_path: Optional[str] = None) -> dict:
        ...
        return {"pattern": name_pattern, "classes": classes, "count": len(classes)}
    ...
    def _get_code_files(self, directory: Path) -> List[Path]:
        ...
        for root, dirs, files in os.walk(directory):
            ...
            dirs[:] = [
                ...
                for d in dirs
                if d
                not in {".git", "__pycache__", "node_modules", ".venv", "venv", "env"}
            ]
